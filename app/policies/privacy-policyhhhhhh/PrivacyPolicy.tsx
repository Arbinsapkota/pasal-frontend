  ...
  return (
    <div className="container mx-auto p-4 pt-16">
      <div className="text-center">
        ...
        <p className="text-xl mb-6">Effective Date: 2025/06/15</p>
        <p>
          Etech International Pvt. Ltd. (&qeots;we&quot;, &quot;our&quot;, or
          &quot;us&quot;) is committed to protecting your privacy. This Privacy
          Policy explains how we collect, use, disclose, and safeguard your
          information when you visit our website and purchase our products,
          including laptops, CCTV systems, and other electronic devices.
        </p>
      </div>
      <section className="mb-8">
        <h2 className="text-3xl font-semibold my-4">Information We Collect</h2>
        <p className="text-xl">
        ...
        <ul>
          <li>
            ...
            phone number, email address, delivery address, and payment details.
          </li>
          <li>
            <span className="font-semibold">• Order History: </span> Details of
            purchases, returns, and inquiries.
          </li>
        </ul>
        <p className="text-xl">
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6">
          <li>
            ...
            payments, fulfill your orders, to send notifications to you related
            to you account, purchases, returns, exchanges or other transactions,
            to create, maintain and otherwise manage your account, to arrange
            for shipping, facilitate any returns and exchanges and to enable you
            to post reviews.
          </li>
          <li>
            <span className="font-semibold mr-1">
            ...
            you advertisements for products or services. This may include using
          ...
          <li>
            ...
            action regarding possible fraudulent, illegal or malicious activity.
            If you choose to use the Services and register an account, you are
          ...
          <li>
            <span className="font-semibold mr-1">Communicating with you.</span>{" "}
      ...
      <section className="mb-8">
        <h2 className="text-3xl font-semibold my-4">Cookies</h2>
        <p className="text-xl mb-4">
          ...
          <a href="https://www.shopify.com/legal/cookies" className="ml-1">
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6">
          ...
          <li>
            ...
            services and advertise to you. We use Shopify to support
            personalized advertising with third-party services. Our business and
            marketing partners will use your information in accordance with
      ...
      <section className="mb-8">
        <h2 className="text-3xl font-semibold my-4">User Generated Content</h2>
        <p className="text-xl">
      ...
      <section className="mb-8">
        <h2 className="text-3xl font-semibold my-4">Children’s Data</h2>
        <p className="text-xl">
      ...
      <section className="mb-8">
        <h2 className="text-3xl font-semibold my-4">Your Rights and Choices</h2>
        <p className="text-xl">
        ...
        <ul className="list-disc pl-6">
          <li>
            <span className="font-bold mr-2">Right to Access / Know.</span>You
            may have a right to request access to personal information that we
            hold about you, including details relating to the ways in which we
            use and share your information.
          </li>
          <li>
            <span className="font-bold mr-2">Right to Delete.</span>You may have
            a right to request that we delete personal information we maintain
            about you.
          </li>
          <li>
            <span className="font-bold mr-2">Right to Correct.</span>You may
            have a right to request that we correct inaccurate personal
            information we maintain about you.
          </li>
          <li>
            <span className="font-bold mr-2">Right of Portability.</span>You may
        ...
        <p className="text-xl mt-2">
          ...
          <a href="https://privacy.shopify.com/en" className="ml-1">
      ...
      <section className="mb-8">
        <h2 className="text-3xl font-semibold my-4">Complaints</h2>
        <p className="text-xl">
      ...
      <section className="mb-8">
        <h2 className="text-3xl font-semibold my-4">International Users</h2>
      </section>
      <p className="text-xl">
      ...
      <section className="mb-8">
        ...
        <p className="text-xl">
          ...
          <span className="mx-1 text-green-400">
            [TOLL FREE TELEPHONE NUMBER] at +1 817-366-0497 or +1 682-276-1334{" "}
          </span>
          or email us at everestnutritionarlington@gmail.com or contact us at
          1011 East Arkansas Lane, Suite 118, Arlington TX 76010, United States.
        </p>
      </section>
    </div>
  );
