...
const TearmsandCondations = () => {
  return (
    <>
      <main className="pb-4 pt-24 bg-white">
        <div className="container mx-auto px-6">
          ...
          <section>
            ...
            <p className="text-lg mb-4">
              This website is operated by Everest Nutrition. Throughout the
              site, the terms “we”, “us” and “our” refer to Everest Nutrition.
              Everest Nutrition offers this website, including all information,
          ...
          <section>
            ...
            <p className="text-lg mb-4">
              ...
              may, at our sole discretion, limit or cancel quantities purchased
          ...
          <section>
            ...
            <p className="text-lg mb-4">
              ...
              that you are familiar with and approve of the terms on which the
          ...
          <section>
            ...
            <p className="text-lg mb-4">
              In no case shall Everest Nutrition, our directors, officers,
              ...
              lost profits, lost revenue, loss of data, or any similar damages,
              whether based in contract, tort (including negligence), strict
              liability or otherwise, arising from your use of any of the
              services or any products procured using the service, or for any
          ...
          <section>
            ...
            <p className="text-lg mb-4">
              You agree to indemnify, defend and hold harmless Everest Nutrition
              and our parent, subsidiaries, affiliates, partners, officers,
              directors, agents, contractors, licensors, service providers,
              subcontractors, suppliers, and employees from any claim or demand,
          ...
          <section>
            ...
            <p className="text-lg mb-4">
              These Terms of Service, along with any policies or operating rules
              posted by us on this site or in respect to The Service,
              constitutes the entire agreement and understanding between you and
              us. It supersedes all prior or contemporaneous agreements,
...
export default TearmsandCondations;
