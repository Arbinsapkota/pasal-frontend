...
const LatestProducts: React.FC = () => {
  ...
  return (
    <div className="p-2 sm:p-4 md:p-6 rounded-lg bg-white">
      <div className="flex flex-row justify-between  sm:gap-4 mb-2 pb-1 ">
        <h1 className="header font-semibold text-gray-800">Special Offers</h1>
        <Button
                ...
                <CarouselContent className="sm:pl-6 pl-3 pb-2 ">
                  {filteredProducts.map((product, index) => {
                    ...
                    return (
                      <CarouselItem
                        key={index}
                        className="basis-1/2 sm:basis-1/3 md:basis-1/3 lg:basis-1/4 xl:basis-1/5 pl-2 basis-sh"
                      >
